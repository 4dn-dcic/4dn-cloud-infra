...
class ApplicationConfigurationSecrets:
    ...
    def build_initial_values(cls):
        ...
        keys_values = {
            ...
            'ENCODED_AUTH0_DOMAIN': ConfigManager.get_config_secret(Secrets.AUTH0_DOMAIN, default=None),
            ...
            'ENCODED_AUTH0_ALLOWED_CONNECTIONS': ConfigManager.get_config_secret(Secrets.AUTH0_ALLOWED_CONNECTIONS,
                                                                                 default=None),
            'ENV_NAME': env_name,
