...
def react_serve_file(environ, **kwargs):
    ...
    return app_utils_manager.singleton.react_serve_file(environ, **kwargs)
...
def react_get_users_route(environ):
    ...
    return app_utils_manager.singleton.react_get_users(request=request, environ=environ, is_admin=is_admin, domain=domain, context=context)
...
def react_get_user_route(environ, email):
    ...
    domain, context = app_utils_manager.singleton.get_domain_and_context(request_dict)
    is_admin = app_utils_manager.singleton.check_authorization(request_dict, environ)
    return app_utils_manager.singleton.react_get_user(request=request, environ=environ, is_admin=is_admin, domain=domain, context=context, email=email)
...
def react_get_info(environ):
    ...
    domain, context = app_utils_manager.singleton.get_domain_and_context(request_dict)
    is_admin = app_utils_manager.singleton.check_authorization(request_dict, environ)
    return app_utils_manager.singleton.react_get_info(request=request, environ=environ, is_admin=is_admin, domain=domain, context=context)
...
def react_get_info_noenv():
    ...
    request_dict = request.to_dict()
    domain, context = app_utils_manager.singleton.get_domain_and_context(request_dict)
    is_admin = app_utils_manager.singleton.check_authorization(request_dict, DEFAULT_ENV)
    return app_utils_manager.singleton.react_get_info(request=request, environ=DEFAULT_ENV, is_admin=is_admin, domain=domain, context=context)
...
def react_get_header_info(environ):
    ...
    request_dict = request.to_dict()
    domain, context = app_utils_manager.singleton.get_domain_and_context(request_dict)
    return app_utils_manager.singleton.react_get_header_info(request=request, environ=environ, domain=domain, context=context)
...
def react_reload_lambda():
    ...
    request_dict = request.to_dict()
    domain, context = app_utils_manager.singleton.get_domain_and_context(request_dict)
    return app_utils_manager.singleton.view_reload_lambda(request=request, environ=DEFAULT_ENV, domain=domain, context=context)
