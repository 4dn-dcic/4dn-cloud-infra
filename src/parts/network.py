...
class C4NetworkExports(C4Exports):
    ...
    _APPLICATION_SECURITY_GROUP_EXPORT_PATTERN = re.compile('.*Network.*ExportApplicationSecurityGroup.*')
    ...
    #       or might not contain '...Alpha...'
    _PRIVATE_SUBNET_EXPORT_PATTERN = re.compile('.*Network.*ExportPrivateSubnet.*')
