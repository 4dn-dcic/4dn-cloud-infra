...
From the CodeBuild console, trigger the job named your environment and the master branch
...
Internal Server Error/502 Error loading CGAP Portal
    ...
    * Check ``/health?format=json`` and ``/counts?format=json``, which will not load the UI. If ES
